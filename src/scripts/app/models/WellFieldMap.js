define(['jquery', 'ko', 'app/datacontext', 'bootstrap-modal.min', 'app/app-helper', 'app/models/WellFieldMapArea', 'app/models/WellInWellFieldMap'],
        ...
        function WellFieldMap(data, wellField) {
            ...
            function initYandexMap(wellFieldMapItem, wellFieldItem) {
                ...
                myAddArea.events.add('click', function () {
                    ...
                    var needArray = $.map(pointArray, function (pValue, pIndex) {
                ...
                myMap.events.add('click', function (e) {
                    if (myAddObj.state.get('selected')) {
                        ...
                        //    iconContent: 'w',
                        //    hintContent: 'Well ' + moment().format('HHmmss')
                        //}, {
