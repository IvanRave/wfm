define(['jquery', 'ko', 'slimscroll', 'jquery.bootstrap', 'bootstrap-datepicker', 'moment'], function ($, ko) {
    'use strict';
    ...
    ko.bindingHandlers.date = {
        update: function (element, valueAccessor, allBindingsAccessor, viewModel) {
            if (ko.unwrap(valueAccessor())) {
                element.innerHTML = moment(new Date(ko.unwrap(valueAccessor()))).format('YYYY-MM-DD');
            }
        }
    };

    function convertFloatToPrec(p) {
    ...
    ko.bindingHandlers.drawCnvsLog = {
        init: function (drawCnvs, valueAccessor, allBindingsAccessor) {
            var startX = 0,
            startY = 0,
            lastX = 0,
            lastY = 0,
            ...
            // for IE lte 8
            window.G_vmlCanvasManager && (drawCnvs = G_vmlCanvasManager.initElement(drawCnvs));
    ...
    ko.bindingHandlers.sldr = {
        init: function (element, valueAccessor, allBindingsAccessor) {
            require(['bootstrap-slider.min'], function () {
